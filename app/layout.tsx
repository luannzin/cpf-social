...
export const metadata: Metadata = {
  ...
  description:
    "CPF Social é uma maneira rápida e segura de gerar números de CPF válidos. Nosso serviço online oferece uma solução conveniente para suas necessidades de documentos, testes e muito mais. Obtenha seu CPF brasileiro de forma simples e confiável, sem complicações.",
  ...
  return (
    <html lang="pt-BR">
      <head>
        ...
        <meta
          name="abstract"
          content="CPF Social é uma maneira rápida e segura de gerar números de CPF válidos. Nosso serviço online oferece uma solução conveniente para suas necessidades de documentos, testes e muito mais. Obtenha seu CPF brasileiro de forma simples e confiável, sem complicações."
        />
        <meta
          name="topic"
          content="CPF Social é uma maneira rápida e segura de gerar números de CPF válidos. Nosso serviço online oferece uma solução conveniente para suas necessidades de documentos, testes e muito mais. Obtenha seu CPF brasileiro de forma simples e confiável, sem complicações."
